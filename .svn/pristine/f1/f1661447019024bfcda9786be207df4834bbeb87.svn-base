...
public class SwipeMenuLayout extends FrameLayout {
	...
	private int[] disableSwipPositions;
	...
	public void setDisableSwipPositions(int... disableSwipPositions) {
		this.disableSwipPositions = disableSwipPositions;
	}
	...
	private boolean isDisable() {
		if (disableSwipPositions == null)
			return false;
		for (int i = 0; i < disableSwipPositions.length; i++) {
			if (disableSwipPositions[i] == position) {
				return true;
			}
		}
		return false;
