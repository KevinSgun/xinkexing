...
public final class DownloadProvider extends ContentProvider {
    ...
    private static final String[] sAppReadableColumnsArray = new String[] {
	    Downloads._ID, Downloads.COLUMN_APP_DATA,Downloads.COLUMN_FILE_UID, Downloads._DATA,
	...
	private void upgradeTo(SQLiteDatabase db, int version) {
		...
		addColumn(db, DB_TABLE, Downloads.COLUMN_DELETED,
			...
			break;
		case 107:
        addColumn(db, DB_TABLE, Downloads.COLUMN_FILE_UID,
                        "TEXT");
		break;
    ...
    copyString(Downloads.COLUMN_FILE_UID, values, filteredValues);
