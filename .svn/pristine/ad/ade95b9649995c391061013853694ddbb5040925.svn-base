...
public class ActionSheet extends Dialog {
     ...
     * 灰色字体
     */
    public static final int GRAY_STYLE_BTN = 6;
     ...
     *
     * @param text      显示的文字
     * @param btnStyleType 按钮字体颜色风格，如RED_STYLE_BTN或BLUE_SYLE_BTN
     */
    ...
    private int getActionButtonColorByType(int type) {
        switch (type) {
            ...
            case BLUE_STYLE_BTN:
                return mResources.getColor(com.zitech.framework.R.color.action_sheet_button_blue);
            case GRAY_STYLE_BTN:
                return mResources.getColor(com.zitech.framework.R.color.action_sheet_button_gray);
            default:
                return mResources.getColor(com.zitech.framework.R.color.action_sheet_button_blue);
        }
    }
     ...
     *
     * @param resid        要显示的文字资源id
     * @param btnStyleType Button字体颜色风格如RED_STYLE_BTN或BLUE_STYLE_BTN
     * @param isChecked    是否选中
     */
    ...
    private void prepareContentViews() {
        ...
        if (mContents != null) {
            ...
            for (int i = 0; i < buttonCount; i++) {
                ...
                //显示设置View的id
                child.setId(i);
                if(pair.second != ActionSheet.GRAY_STYLE_BTN)
