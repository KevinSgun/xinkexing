...
import com.thinkeract.tka.widget.timepicker.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public OptionsPickerView(Context context) {
        super(context);
        mContentView = LayoutInflater.from(context).inflate(R.layout.pickerview_options, null);
        // -----确定和取消按钮
        ...
        // ----转轮
        final View optionspicker = mContentView.findViewById(R.id.optionspicker);
