package com.thinkeract.tka.widget.timepicker.lib;
...
import com.thinkeract.tka.widget.timepicker.adapter.WheelAdapter;
 ...
 * 3d滚轮控件,
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) public class WheelView extends View {
    ...
    private static final float CENTERCONTENTOFFSET = 3.5F;//中间文字文字居中需要此偏移值
    private String GETPICKERVIEWTEXT = "getCirclename";//反射的方法名
    ...
    public void setGETPICKERVIEWTEXT(String GETPICKERVIEWTEXT) {
        this.GETPICKERVIEWTEXT = GETPICKERVIEWTEXT;
    }
