...
public class MyLoadViewFactory implements ILoadViewFactory {
	...
	private class LoadMoreHelper implements ILoadMoreView {
		...
		public void init(FootViewAdder footViewHolder, OnClickListener onClickRefreshListener) {
			footView = (TextView) footViewHolder.addFootView(R.layout.mvc_listview_foot);
		...
		@Override
		public void showNoMore(boolean isOnlyOnePage) {
			footView.setText(isOnlyOnePage?"":"已经加载完毕");
			footView.setOnClickListener(null);
		}
...
//		private VaryViewHelper helper;
		...
		@Override
		public View getContentViewHolder() {
			return holder;
		}
	}
}
