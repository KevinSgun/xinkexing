package com.thinkeract.tka.ui.preview.widget;
...
public class SmoothPhotoView extends PhotoView {
    ...
    private boolean tranformInEnable=true;
...
//		setBackgroundColor(mBgColor);
    ...
    public void setTranformInEnable(boolean tranformInEnable) {
        this.tranformInEnable = tranformInEnable;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!originInited||(!tranformInEnable&&mState == STATE_TRANSFORM_IN )) {
            super.onDraw(canvas);
        } else {
            if (mState == STATE_TRANSFORM_IN || mState == STATE_TRANSFORM_OUT) {
                ...
                if (mTransformStart) {
                    Logger.d("Dean", "mTransfrom.startScale:" + mTransfrom.startScale);
                    Logger.d("Dean", "mTransfrom.startScale:" + mTransfrom.endScale);
                    Logger.d("Dean", "mTransfrom.scale:" + mTransfrom.scale);
                    Logger.d("Dean", "mTransfrom.startRect:" + mTransfrom.startRect.toString());
                    Logger.d("Dean", "mTransfrom.endRect:" + mTransfrom.endRect.toString());
                    Logger.d("Dean", "mTransfrom.rect:" + mTransfrom.rect.toString());
                }
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public synchronized void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mTransformListener != null) {
                    mTransformListener.onTranforming(mTransfrom.scale,state);
                }
            }
        });
    ...
    public static interface TransformListener {
        ...
        void onTranforming(float scale, int mode);
        /**
