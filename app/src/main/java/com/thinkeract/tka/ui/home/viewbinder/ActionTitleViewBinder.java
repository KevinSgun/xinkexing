 ...
 * @author ymh
 */
public class ActionTitleViewBinder extends ItemViewBinder<ActionTitleItem, ActionTitleViewBinder.ViewHolder> {

    @NonNull @Override
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        View view = inflater.inflate(R.layout.item_action_title, parent, false);
        return new ViewHolder(view);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull ActionTitleItem item) {
        holder.mTitleTv.setBackgroundResource(item.getColorTypeResId());
        holder.mTitleTv.setText(item.getTitle());
    }

    static class ViewHolder extends RecyclerView.ViewHolder {

        private @NonNull final TextView mTitleTv;
