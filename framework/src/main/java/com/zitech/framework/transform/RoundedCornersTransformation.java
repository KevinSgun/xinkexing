...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    public RoundedCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL,1f);
    }

    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin) {
        this(pool, radius, margin, CornerType.ALL,1f);
    }

    public RoundedCornersTransformation(BitmapPool pool, int radius, int margin,float rate) {
        this(pool, radius, margin, CornerType.ALL,rate);
    }

    public RoundedCornersTransformation(Context context, int radius, int margin,
                                        CornerType cornerType,float rate) {
        this(Glide.get(context).getBitmapPool(), radius, margin, cornerType,rate);
    }
    ...
    public Resource<Bitmap> transform(Context context, Resource<Bitmap> resource, int outWidth, int outHeight) {
        ...
        float expectWidth = (height * rate);
        float expectHeight = (width / rate);
        float wRate = width / expectWidth;
        float hRate = height / expectHeight;
