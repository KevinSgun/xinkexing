...
public class SwipeMenuListView extends ListView {
	...
	public void setAdapter(ListAdapter adapter) {
		...
		mAdapter.setDisableSwipPositions(disableSwipPositions);
		super.setAdapter(mAdapter);
	}

	public void setDisableSwipePositions(int... positions) {
		if (mAdapter != null)
			mAdapter.setDisableSwipPositions(positions);
		this.disableSwipPositions = positions;
	}
